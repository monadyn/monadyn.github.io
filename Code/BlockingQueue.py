...
if __name__ == "__main__":
    ...
    consumerThread1 = Thread(target=consumer_thread, name="consumer-1", args=(blocking_q,), daemon=0)
    consumerThread2 = Thread(target=consumer_thread, name="consumer-2", args=(blocking_q,), daemon=0)
    producerThread1 = Thread(target=producer_thread, name="producer-1", args=(blocking_q, 1), daemon=0)
    producerThread2 = Thread(target=producer_thread, name="producer-2", args=(blocking_q, 100), daemon=0)
